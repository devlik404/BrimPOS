...
export class MyMigration1696586730260 implements MigrationInterface {
    name = 'MyMigration1696586730260'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "product_foods" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "price" double precision NOT NULL, "productsId" uuid, CONSTRAINT "PK_5e49eafd3b0d77f9771e3722c20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_beverages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "price" double precision NOT NULL, "productsId" uuid, CONSTRAINT "PK_6c73f909ff4ce9b43717ad7478e" PRIMARY KEY ("id"))`);
